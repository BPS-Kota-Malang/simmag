                    ...
                    <div class="collapse navbar-collapse pt-3 pb-2 py-lg-0 w-100 nav-right" id="navigation">
                        <ul class="navbar-nav navbar-nav-hover ms-lg-10 ps-lg-12 w-100">
                            ...
                            <li class="nav-item">
                                ...
                                <div class="dropdown">
                                    <a class="btn-sm dropdown-toggle btn-round mb-0 me-1 mt-2 mt-md-0 pt-1" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
                                        <div class="d-sm-none d-lg-inline-block">Presensi</div>
                                    </a>
                                    <ul class="dropdown-menu px-2 py-3" aria-labelledby="dropdownMenuButton">
                                        <li><a class="dropdown-item border-radius-md" href="{{route ('presensi-masuk')}}">Presensi Masuk</a></li>
                                        <li><a class="dropdown-item border-radius-md" href="{{route ('presensi-keluar')}}">Presensi Pulang</a></li>
                                    </ul>
                                </div>
                            </li>
                            <!-- <a class="nav-link ps-2 d-flex justify-content-between cursor-pointer align-items-center" href="{{ url('/') }}" aria-expanded="false">
                            ...
                            <li class="nav-item">
                                <div class="dropdown">
                                    <a class="btn-sm dropdown-toggle btn-round mb-0 me-1 mt-2 mt-md-0 pt-1" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
                                        <img alt="image" src="https://ui-avatars.com/api/?name={{ Auth::user()->name }}&background=random" alt="profile_image" class="rounded-circle mr-1" style="height: 30px">
